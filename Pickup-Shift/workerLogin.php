...
<html>
    ...
    <head>
        ...
        <title>Pickup-Shift || Worker Login</title>
        ...
        <section class="hero is-fullheight">
            <div class="hero-body">
                <div class="container">
                    ...
                    <h1 class="title is-2 has-text-centered">Worker Login</h1>
                    ...
                    <form method="GET" action="" class="box">
                        ...
                        <br>
                        <div>
                            <input type="submit" value="Login" class="button is-large is-fullwidth is-success" name="but_submit" id="but_submit" />
                        </div>
                    </form>
                </div>
            </div>
...
$db = db_Connect();
//SQL statement
$stmt = $db->prepare("SELECT * FROM workers WHERE email = :username AND passw = :password");
